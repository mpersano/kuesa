...
QT_BEGIN_NAMESPACE
namespace Kuesa {
DracoExportPass::DracoExportPass(QDir source, QDir destination, const QJsonObject &rootObject, const GLTF2ExportConfiguration &conf, GLTF2Import::GLTF2Context &context)
    : m_root(rootObject)
...
DracoExportPass::CompressedGLTFPrimitive DracoExportPass::compressPrimitive(QJsonObject primitive_json, const GLTF2Import::Primitive &primitive) const
{
...
int DracoExportPass::mapBufferOffset(const std::set<DracoExportPass::BufferParts> &removed_parts, int offset)
{
...
std::set<int> DracoExportPass::cleanAccessors(QJsonArray &accessors, const std::set<int> &indices)
{
